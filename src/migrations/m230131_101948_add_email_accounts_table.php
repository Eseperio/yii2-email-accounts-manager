...
//        Create a table with all the fields that you need to store the email accounts
        $this->createTable('{{%email_account}}', [
            ...
            'smtp_encryption' => $this->string(255)->notNull()->defaultValue('tls'),
            'imap_encryption' => $this->string(255)->notNull()->defaultValue('tls'),
            'smtp_validate_cert' => $this->boolean()->notNull()->defaultValue(true),
            'imap_validate_cert' => $this->boolean()->notNull()->defaultValue(true),
